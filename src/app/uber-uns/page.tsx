        ...
        <div className="grid">
          ...
          <div className="grid grid-cols-2 text-2xl border-t">
            ...
            <p className="border-l p-5 text-[rgba(110,110,115,1)]">
              ...
              Gemeinsam entwickeln wir ein klares Profil, das zeigt, was dich ausmacht. Wir helfen dir, Bewerbungen zu schreiben, Vorstellungsgespräche zu meistern und die passende Stelle zu finden. Aber nicht irgendeine – <span className="important-word">eine, die wirklich zu dir passt.</span>
              <br /> <br />
              Und weil Wissen Türen öffnet, beraten wir dich auch zu Weiterbildungen und Qualifizierungen. Du willst gründen? Auch gut! Mit unserem <span className="important-word">Existenzgründungscoaching</span> machen wir aus deiner Idee ein tragfähiges Geschäft.
            </p>
          </div>
          ...
          <p className="text-[80px] leading-[80px] p-5 border-t border-b">Ihr Erfolg ist unser Ziel.</p>
